...
def main():
    # Carga tus x_train, y_train, x_test, y_test
    # (Asegúrate de que las rutas y nombres coincidan con tu repositorio)
    ...
    pipeline = Pipeline([
        ...
        # Quita class_weight si la precisión está muy baja:
        ("svc", SVC())  
    ])

    param_grid = {
        "pca__n_components": [None, 10, 20, 30],  # Exploramos
